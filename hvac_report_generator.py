...
_REPORT_SECTIONS = (
    (
        "Airflow",
        (
            ("supplyStaticPressure", "Supply Static Pressure"),
            ("returnStaticPressure", "Return Static Pressure"),
            ("totalExternalStaticPressure", "Total External Static Pressure"),
            ("designStaticPressure", "Design Static Pressure"),
            ("designCfm", "Design CFM"),
            ("actualCfm", "Actual CFM"),
    ...
    (
        ...
        (
            ...
            ("targetSuctionPressure", "Target Suction Pressure"),
            ("highSidePressure", "High Side Pressure"),
            ("targetHighSidePressure", "Target High Side Pressure"),
            ("superheat", "Superheat"),
            ("targetSuperheat", "Target Superheat"),
            ("subcooling", "Subcooling"),
            ("targetSubcooling", "Target Subcooling"),
            ("notesOnRefrigerant", "Notes on Refrigerant"),
        ),
    ),
    (
        "Electrical",
        (
            ...
            ("compressorRla", "Compressor RLA"),
            ("capacitors", "Capacitors"),
            ("thermostat", "Thermostat"),
            ("transformers", "Transformers"),
            ("blowerMotorVoltage", "Blower Motor Voltage"),
            ("condenserFanVoltage", "Condenser Fan Voltage"),
    ...
    (
        "Ductwork",
        (
            ("properlySized", "Properly Sized?"),
            ("leaks", "Leaks?"),
            ("wellInsulated", "Well-Insulated?"),
            ("wellSupported", "Well-Supported?"),
            ("damaged", "Damaged?"),
            ("clean", "Clean?"),
            ("dampersFunctioningProperly", "Dampers Functioning Properly?"),
            ("notesOnDuctwork", "Notes on Ductwork"),
        ),
    ),
    (
        "Indoor Air Quality",
        (
            ...
            ("iaqTemperature", "Temperature"),
            ("vocLevels", "VOC Levels"),
            ("pm25", "PM 2.5"),
            ("pm10", "PM10"),
            ("moldOrMildew", "Mold / Mildew"),
            ("odors", "Odors"),
        ),
    ),
)
